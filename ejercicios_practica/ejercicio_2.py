...
if len(texto_1) > len(texto_2):
    print(texto_1, 'tiene la mayor cantidad de letras')
elif len(texto_1) == len(texto_2):
    print('{} y {}, tienen la misma cantidad de letras'.format(texto_1, texto_2))
else:
    print(texto_2, 'tiene la mayor cantidad de letras')
...
if texto_1[0] > texto_2[0]:
    print('la primera letra de {} es mayor que la primera letra de {}'.format(texto_1, texto_2))
elif texto_1[0] == texto_2[0]:
    print('la primera letra de {} y {} son iguales'.format(texto_1, texto_2))
else:
    print('la primera letra de {} es mayor que la primera letra de {}'.format(texto_2, texto_1))
